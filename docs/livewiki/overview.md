...
path: overview.md
page-type: overview
summary: High-level introduction and architectural overview of the ChatUI widget system with composable widgets.
...
ChatUI is a professional, ultra-lightweight chat UI widget built with **pure Vanilla JavaScript**. It is frontend-only, framework agnostic, and designed to be “live in 30 seconds” with minimal integration effort.
