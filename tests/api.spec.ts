...
test.describe("HybridChatAPI", () => {
  ...
  test.describe("WebSocket Connection", () => {
    ...
    test("should flush message queue after connection", async () => {
      ...
      const sentMessage = (api.wsConnection as any).sentMessages.find(
        (msg: string) => {
  ...
  test.describe("Real-time Features", () => {
    ...
    test("should send typing indicator", async () => {
      ...
      const typingMessage = (api.wsConnection as any).sentMessages.find(
        (msg: string) => {
          const parsed = JSON.parse(msg);
    ...
    test("should send read receipt", async () => {
      ...
      const readReceiptMessage = (api.wsConnection as any).sentMessages.find(
        (msg: string) => {
          const parsed = JSON.parse(msg);
